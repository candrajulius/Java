 ...
 */
public class BiasaAja extends javax.swing.JFrame {
    ...
    private void button15ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        switch(pilih){
            case 1 :
                julius = Double.parseDouble(budi);
                hasil = candra1 + julius;
//                budi = Double.toString(hasil);
                textField1.setText("" + hasil);
        }
    ...
    private void button5ActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here
        candra1 = Double.parseDouble(budi);
        textField1.setText("+");
        budi = textField1.getText();
        pilih = 1;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BiasaAja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
